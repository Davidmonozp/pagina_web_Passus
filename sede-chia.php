...
<body>
	...
	<div class="super_container">
		...
		<div class="home d-flex flex-column align-items-start justify-content-end" style="background-color: rgba(44, 62, 80, 0); ">
			<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/sedes/chia-1.png" data-speed="0.8"></div>
					...
					<div class="row">
						<div class="col">
							<div class="home_content px-2" style="background-color: rgba(54, 149, 235, 0.8);">
								...
								<div class="home_text" style="font-size: 35px; margin-left: 12px; margin-right: 12px;">Rehabilitación integral - Chía</div>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="contact_content">
								...
								<div class="col-md-12">
									...
									-->
										...
										<!--		
									<div class="accordion_container">
										<div class="accordion d-flex flex-row align-items-center"><div>Intramural</div></div>
										<div class="accordion_panel px-4 py-0">
											<div class="col-md-12 py-0">
												...
												<ol class="px-4 py-2">
													<li>Fisioterapia</li>
													<li>Medicina Física y rehablitación.</li>
													<li>Terapia de lenguaje / Fonoaudiológica.</li>
													<li>Psicología.</li>
													<li>Psiquiatria infantil y adolescente.</li>
													<li>Terapia ocupacional.</li>
													<li>Psiquiatría pediátrica.</li>
												</ol>
											</div>
										</div>
									</div>
