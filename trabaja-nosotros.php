...
COLOR VERDE PASSUS #00A54F -->
			...
			<div class="container" id="trabaja_nosotros">
				<div class="row">
					...
					<div class="col text-center" style="margin-top: 60px;">
						<div class="section_title_container">
							<div class="section_title_nosotros">
								<h2 class="titulo-trabaja-nosotros">¿Qué te ofrecemos?</h2><br><br>
							</div>
							<ul style="color: black; text-align: left; padding-left: 20px; font-weight: 500; list-style-type: disc;">
								<li class="parrafo">Formación continua y oportunidades de crecimiento.</li>
								<li class="parrafo">Trabajo colaborativo con profesionales apasionados.</li>
								<li class="parrafo">Entorno innovador con tecnología de punta.</li>
								<li class="parrafo">Beneficios y salarios competitivos.</li><br>
							</ul>
						</div>
					</div>
	...
	<!-- Como aplicar -->
	<br>
	<div class="container" id="como_aplicar">
		<div class="row" id="n">

			<div class="col text-center">
				<div class="section_title_container">
					<div class="section_title">
						<h2 class="titulo-como-aplicar">¿Cómo aplicar?
						</h2>
					</div>
				</div>
			</div>
			...
			<div class="why_text">
				...
				<div class="logo-oferta">
					<a href="#ofertas-destino">
						<img src="images/logo.png" alt="" class="passus-logo">
					</a>
