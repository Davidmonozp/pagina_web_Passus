...
<header class="header trans_400">
			...
			<div class="top-left">
				<ul class="contact-links p-0 m-0">
					<li class="item" style="color:white">
						<i class="fa fa-headphones mr-0 icon-box"></i>
						<strong>CallCenter:</strong>
						<a href="tel:+576013161699">
							<span>(601) 316 16 99</span>
						</a>
					</li>
					<li class="item">
	...
	<div class="header_content d-flex flex-row align-items-center jusity-content-start trans_400">
		...
		<nav class="main_nav" id="nav">
			<ul class="navbar-nav ml-auto d-flex flex-row align-items-center justify-content-start">
				<li class="nav-item">
					<a class="nav-link" href="index">Inicio</a>
				</li>
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Conócenos</a>
					<div class="dropdown-menu" aria-labelledby="dropdown01">
						<a class="dropdown-item" href="derechos-deberes">Derechos y Deberes</a>
						<a class="dropdown-item" href="nosotros-quienes-somos">Quiénes Somos</a>
						<a class="dropdown-item" href="nosotros-resena-historica">Reseña Histórica</a>
				...
				<!--		    <li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Conoce más</a>
		...
		<div class="header_extra d-flex flex-row align-items-center justify-content-end ml-auto">
			...
			<div class="social header_social">
				<ul class="d-flex flex-row align-items-center justify-content-start">
					...
					<li title="Youtube"><a href="https://www.youtube.com/@passuscolombia" target="_blank"><i class="fab fa-youtube" aria-hidden="true"></i></a></li>
					<li title="TikTok"><a href="https://www.tiktok.com/@passusipscolombia" target="_blank"><i class="fab fa-tiktok" aria-hidden="true"></i></a></li>
...
<div class="menu trans_400">
		...
		<ul>
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownR01" style="width: 250px; min-width: 250px;">
					...
					<a class="dropdown-item" href="nosotros-quienes-somos" style="font-size: 13px;">Quiénes Somos</a>
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownR02" style="width: 320px; min-width: 320px;">
					<a class="dropdown-item" href="sede-bogota-americas-1" style="font-size: 12px;">Rehabilitación Integral Bogotá - Sur Occidente</a>
					<a class="dropdown-item" href="sede-bogota-americas-2" style="font-size: 12px;">Hidroterapia Bogotá - Sur Occidente</a>
					<a class="dropdown-item" href="sede-bogota-cedritos" style="font-size: 13px;">Hidroterapia Bogotá - Norte</a>
					<a class="dropdown-item" href="sede-bogota-veraguas" style="font-size: 13px;">Hidroterapia Bogotá - Centro</a>
					<a class="dropdown-item" href="sede-florencia" style="font-size: 13px;">Rehabilitación Integral - Florencia</a>
					<a class="dropdown-item" href="sede-ibague" style="font-size: 13px;">Rehabilitación Integral - Ibagué</a>
					<a class="dropdown-item" href="sede-chia" style="font-size: 13px;">Rehabilitación Integral - Chía</a>
				</div>
			</li>
			<!--		<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle px-0" href="#" id="dropdownR03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Conoce más</a>
			        <div class="dropdown-menu" aria-labelledby="dropdownR03" style="width: 250px; min-width: 250px;">
                      		<a class="dropdown-item" href="derechos-deberes" style="font-size: 13px;">Derechos y Deberes</a>
			        </div>
				</li> -->
	...
	<div class="social menu_social">
		<ul class="d-flex flex-row align-items-center justify-content-start">
			<li><a href="https://www.facebook.com/passuscolombia" target="_blank"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
			<li><a href="https://www.instagram.com/passuscolombia/" target="_blank"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
			<li><a href="https://www.youtube.com/@passusips2024" target="_blank"><i class="fab fa-youtube" aria-hidden="true"></i></a></li>
			<li><a href="https://www.tiktok.com/@passus_ips" target="_blank"><i class="fab fa-tiktok" aria-hidden="true"></i></a></li>
		</ul>
	</div>
</div>