...
<body>
    ...
    <div class="contact" id="contactanos">
        <div class="header-pqrs">
            ...
            <h2>Déjanos tus felicitaciones o sugerencias, ¡Tu opinión nos impulsa a mejorar cada día!</h2>
            <hr class="hr_subtitulo">
            <!-- <p class="parrafo">Hemos actualizado nuestro formulario de radicación. <br>
                Con el objetivo de brindarte una atención más ágil y de mayor calidad, ahora puedes registrar y consultar tus solicitudes a través de las siguientes opciones:</p> -->
            <p class="parrafo">
                ¡En PASSUS estamos ampliando y centralizando nuestros canales de comunicación! 
            </p>
        </div>

        <div class="cards-pqrs">
            <a href="https://test-fpqrs.passus.cloud/felicitacion" class="card-link" target="_blank">
                <div class="card-felicitacion">
                    <img src="./images/felicitacion.png" alt="Felicitación">
                    <h4 class="titulo-card">Felicitaciones</h4>
                    <p>Registra aquí tus felicitaciones y ayúdanos a seguir mejorando desde el reconocimiento.
                    </p>
                </div>
            </a>

            <a href="https://test-fpqrs.passus.cloud/solicitudes" class="card-link" target="_blank">
                <div class="card-solicitud">
                    <img src="./images/solicitudes.png" alt="Solicitudes">
                    <h4 class="titulo-card">Solicitudes</h4>
                    <p>En esta sección puedes registrar tus solicitudes como:</p>
                    <ul>
                        <li>Agendamiento</li>
                        <li>Reprogramación de citas</li>
                        <li>Solicitudes de Tesorería</li>
                        <li>Envío de historia clínica ó informes finales</li>
                        <li>Política de Multas por inasitencia</li>
                    </ul>
                </div>
            </a>

            <a href="https://test-fpqrs.passus.cloud/pqrsForm" class="card-link" target="_blank">
                <div class="card-pqr">
                    <img src="./images/registro.png" alt="Registra tu PQR">
                    <h4 class="titulo-card">PQR</h4>
                    <p>Aquí puedes radicar tus Peticiones, Quejas ó Reclamos relacionados con nuestros servicios.</p>
                </div>
            </a>

            <a href="https://test-fpqrs.passus.cloud/consultar-radicado" class="card-link" target="_blank">
                <div class="card-consulta">
                    <img src="./images/consulta.png" alt="Consulta tu PQRS">
                    <h4 class="titulo-card">Consulta tu PQR/S</h4>
                    <p># de Radicado</p>
                    <p>Ingresa el número de radicado y haz seguimiento al estado de tus Peticiones, Quejas, Reclamos ó Solicitudes ya registradas.</p>
                </div>
            </a>
        </div>
        <p class="parrafo-frase">
            Tus ideas nos transforman y juntos construimos un servicio cada vez más humano, ágil y de calidad.
        </p>
