...
<body>
	...
	<div class="super_container">
		...
		<div class="home d-flex flex-column align-items-start justify-content-end" style="background-color: rgba(44, 62, 80, 0); ">
			<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/sedes/norte-2.png" data-speed="0.8"></div>
					...
					<div class="row">
						<div class="col">
							<div class="home_content px-2" style="background-color: rgba(54, 149, 235, 0.8);">
								...
								<div class="home_text" style="font-size: 35px; margin-left: 12px; margin-right: 12px;">Hidroterapia - Bogotá Norte</div>
							</div>
						</div>
					</div>
				</div>
									...
									<div class="accordions">
										...
										<div class="accordion_container">
											<div class="accordion d-flex flex-row align-items-center active">
												<div>Consultas especializadas</div>
											</div>
										...
										<div class="accordion_container">
											...
											<div class="accordion_panel px-4 py-0">
												<div class="col-md-12 py-0">
													...
													<ol class="px-4 py-2" style="list-style-type: disc">
