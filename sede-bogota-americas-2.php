...
<body>
	...
	<div class="super_container">
		...
		<div class="home d-flex flex-column align-items-start justify-content-end" style="background-color: rgba(44, 62, 80, 0); ">
			<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/sedes/hdt-Suroccidente-1.png" data-speed="0.8"></div>
			<div class="home_container">
				<div class="container">
					<div class="row">
						<div class="col">
							<div class="home_content px-2" style="background-color: rgb(24, 113, 191);  border-radius: 20px; opacity: 0.9"">
				<!--	<div class=" home_title" style="font-size: 50px; margin-left: 12px; margin-right: 12px;">Sedes</div> -->
							<div class="home_text" style="font-size: 35px; margin-left: 12px; margin-right: 12px;">Hidroterapia - Bogotá Sur Occidente</div>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="contact_content">
							...
							<div class="col-md-12">
								<div class="accordions">
									...
									<div class="accordion_container">
										<div class="accordion d-flex flex-row align-items-center"><div>Programa de Hidroterapia o terapia Hídrica</div></div>
										<div class="accordion_panel px-4 py-0">
											<div class="col-md-12 py-0">
